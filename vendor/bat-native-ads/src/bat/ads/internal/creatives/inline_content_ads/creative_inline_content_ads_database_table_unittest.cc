...
class BatAdsCreativeInlineContentAdsDatabaseTableTest : public UnitTestBase {
 protected:
  void SetUp() override {
    ...
    database_table_ = std::make_unique<CreativeInlineContentAds>();
  }

  std::unique_ptr<CreativeInlineContentAds> database_table_;
};
...
TEST_F(BatAdsCreativeInlineContentAdsDatabaseTableTest,
  ...
  info_1.target_url = GURL("https://asil.com/1");
  info_1.title = "Test Ad 1 Title";
  info_1.description = "Test Ad 1 Description";
  info_1.image_url = GURL("https://www.asil.com/1/image.png");
  ...
  info_2.target_url = GURL("https://asil.com/2");
  info_2.title = "Test Ad 2 Title";
  info_2.description = "Test Ad 2 Description";
  info_2.image_url = GURL("https://www.asil.com/2/image.png");
...
TEST_F(BatAdsCreativeInlineContentAdsDatabaseTableTest,
  ...
  info_3.target_url = GURL("https://asil.com/3");
  info_3.title = "Test Ad 3 Title";
  info_3.description = "Test Ad 3 Description";
  info_3.image_url = GURL("https://www.asil.com/3/image.png");
...
TEST_F(BatAdsCreativeInlineContentAdsDatabaseTableTest,
  ...
  info.geo_targets = {"US"};
  info.target_url = GURL("https://asil.com");
  info.title = "Test Ad Title";
  info.description = "Test Ad Description";
  info.image_url = GURL("https://www.asil.com/image.png");
