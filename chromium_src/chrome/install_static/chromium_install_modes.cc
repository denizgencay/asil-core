...
const InstallConstants kInstallModes[] = {
    // The primary install mode for stable Asil.
    {
        ...
        .prog_id_description = L"Asil HTML Document",  // ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Asil Beta
    {
        ...
        .prog_id_prefix = L"AsilHTML",  // ProgID prefix.
        .prog_id_description =
            L"Asil Beta HTML Document",  // ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Asil Dev
    {
        ...
        .prog_id_description =
            L"Asil Dev HTML Document",  // ProgID description.
        .active_setup_guid =
    ...
    // A secondary install mode for Asil SxS (canary).
    {
        ...
        .prog_id_description =
            L"Asil Nightly HTML Document",  // ProgID description.
        .active_setup_guid =
...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Asil developer build.
    {
        ...
        .prog_id_description =
            L"Asil Development HTML Document",  // ProgID description.
        .active_setup_guid =
