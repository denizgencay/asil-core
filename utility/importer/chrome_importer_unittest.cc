...
TEST_F(ChromeImporterTest, ImportHistory) {
  ...
  EXPECT_EQ("https://asil.com/", history[0].url.spec());
...
TEST_F(ChromeImporterTest, ImportBookmarks) {
  ...
  EXPECT_EQ("https://asil.com/", bookmarks[2].url.spec());
...
TEST_F(ChromeImporterTest, ImportFavicons) {
  ...
  EXPECT_EQ("https://asil.com/images/cropped-brave_appicon_release-32x32.png",
