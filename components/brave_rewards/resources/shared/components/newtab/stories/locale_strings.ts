...
export const localeStrings = {
  ...
  rewardsBraveRewards: 'Asil Rewards',
  rewardsClaimRewards: 'Claim Rewards',
  rewardsClaimTokens: 'Claim Tokens',
  rewardsConnectAccount: 'Connect account',
  rewardsConnectAccountNoProviders: 'To start earning BAT, you need to connect a custodial account to Asil Rewards. Unfortunately, there’s no custodian available in your region, so earning isn’t available at this time. However, you’ll still be automatically supporting creators by using Rewards.',
  ...
  rewardsEnableBraveAds: 'Enable Asil Ads',
  ...
  rewardsOptInText: 'Earn tokens by viewing Asil Private Ads and support content creators automatically.',
  ...
  rewardsPublisherCountText: 'This month, you\'ve visited $1 creators supported by Asil Rewards',
  rewardsSelectCountryHeader: 'Select your country',
  rewardsSelectCountryText: 'To continue using Asil Rewards, select your country so we can show you the right options and ads for your region. $1Privacy Policy$2',
