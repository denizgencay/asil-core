...
export const localeStrings = {
  ...
  adsSubdivisionTargetingDescription: 'This allows Asil to show you ads meant specifically for your region.',
  adsSubdivisionTargetingLearn: 'Learn More',
  adsDesc: 'Asil Private Ads are unobtrusive and private by design. Ads are based on your interests, but no personal data or browsing history ever leaves your device. Best of all, Asil Private Ads let you earn BAT ($1Basic Attention Token$2) just for viewing.',
  ...
  settings: 'Settings',
  rewardsBrowserCannotReceiveAds: 'Oops! Your browser cannot receive Asil Private Ads.',
  ...
  connectAccountNoProviders: 'To start earning BAT, you need to connect a custodial account to Asil Rewards. Unfortunately, there\'s no custodian available in your region, so earning isn\'t available at this time. However, you\'ll still be automatically supporting creators by using Rewards.',
