...
// When enabled, Asil will block first-party requests that appear in a filter
// list when Shields is in "standard" blocking mode. When disabled, Asil will
...
// When enabled, Asil will issue DNS queries for requests that the adblock
...
// When enabled, Asil will apply HTML element collapsing to all images and
...
BASE_FEATURE(kBraveAdblockCollapseBlockedElements,
             ...
             base::FEATURE_ENABLED_BY_DEFAULT);
// When enabled, Asil will enable "Easylist-Cookie List" by default unless
// overridden by a locally set preference.
BASE_FEATURE(kBraveAdblockCookieListDefault,
             "BraveAdblockCookieListDefault",
             base::FEATURE_DISABLED_BY_DEFAULT);
// When enabled, Asil will display a bubble inviting the user to turn on the
...
BASE_FEATURE(kBraveAdblockCspRules,
             ...
             base::FEATURE_ENABLED_BY_DEFAULT);
// When enabled, Asil will enable "Fanboy's Mobile Notifications List" by
...
BASE_FEATURE(kBraveAdblockMobileNotificationsListDefault,
             ...
             base::FEATURE_DISABLED_BY_DEFAULT);
// When enabled, Asil will block domains listed in the user's selected adblock
...
BASE_FEATURE(kBraveDomainBlock,
             "BraveDomainBlock",
             base::FEATURE_ENABLED_BY_DEFAULT);
// When enabled, Asil will attempt to enable 1PES mode in a standard blocking
...
// potentially blocked by Asil Shields.
BASE_FEATURE(kBraveExtensionNetworkBlocking,
             "BraveExtensionNetworkBlocking",
             base::FEATURE_DISABLED_BY_DEFAULT);
// When enabled, language headers and APIs may be altered by Asil Shields.
BASE_FEATURE(kBraveReduceLanguage,
             "BraveReduceLanguage",
             base::FEATURE_ENABLED_BY_DEFAULT);
// When enabled, Asil will always report Light in Fingerprinting: Strict mode
