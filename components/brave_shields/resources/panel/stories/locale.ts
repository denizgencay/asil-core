...
provideStrings({
  braveShields: 'Asil Shields',
  braveShieldsStandalone: 'Shields',
  braveShieldsEnable: 'Enable Asil Shields',
  braveShieldsUp: 'Shields are UP $1for$2',
  braveShieldsDown: 'Shields are DOWN $1for$2',
  braveShieldsBroken: 'If this site seems broken, try Shields down. $1Note: this may reduce Asil\'s privacy protections.$2',
  braveShieldsBlockedNote: 'Trackers, ads, and more blocked $1Learn more$2',
  braveShieldsNOTBlockedNote: 'Not protected by Asil Shields $1Learn more$2',
  ...
  braveShieldsDownDesc: 'You are viewing this site without Asil\'s privacy protection',
