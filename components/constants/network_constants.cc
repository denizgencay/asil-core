...
const char kBraveReferralsServer[] = "laptop-updates.asil.com";
const char kBraveReferralsInitPath[] = "/promo/initialize/nonua";
const char kBraveReferralsActivityPath[] = "/promo/activity";

const char kBraveSafeBrowsing2Proxy[] = "safebrowsing2.asil.com";
const char kBraveSafeBrowsingSslProxy[] = "sb-ssl.asil.com";
const char kBraveRedirectorProxy[] = "redirector.asil.com";
const char kBraveClients4Proxy[] = "clients4.asil.com";
const char kBraveStaticProxy[] = "static1.asil.com";
...
const char kBravePartnerHeader[] = "X-Asil-Partner";
