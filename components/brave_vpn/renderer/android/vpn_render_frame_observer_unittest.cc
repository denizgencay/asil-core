...
TEST(VpnRenderFrameObserverTest, ExtractParam) {
  ...
  EXPECT_EQ(
      observer.ExtractParam(
          GURL("https://account.asil.com/?intent=connect-receipt&product=vpn"),
          "intent"),
      "connect-receipt");
  EXPECT_EQ(
      observer.ExtractParam(
          GURL("https://account.asil.com/"
  ...
  EXPECT_TRUE(observer
                  .ExtractParam(GURL("https://account.asil.com/"
  ...
  EXPECT_TRUE(observer
                  ...
                  .empty());
  EXPECT_TRUE(
      observer.ExtractParam(GURL("https://account.asil.com/"), "intent")
          .empty());
