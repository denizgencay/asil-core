...
#ifndef BRAVE_COMPONENTS_DEBOUNCE_BROWSER_DEBOUNCE_NAVIGATION_THROTTLE_H_
#define BRAVE_COMPONENTS_DEBOUNCE_BROWSER_DEBOUNCE_NAVIGATION_THROTTLE_H_
...
#endif  // BRAVE_COMPONENTS_DEBOUNCE_BROWSER_DEBOUNCE_NAVIGATION_THROTTLE_H_
